...
{
	string berkas;
	cout <<"Masukkan nama file baru: ";//cara mengganti variabel dengan mudah adalah dengan cara 
	cin >> berkas;                     //mengklik search dan pili replace text yang ingin di ubah
	
	ofstream gas(berkas.c_str());
	if(gas.is_open()) //(gas)adalah variabel
	{
		gas.close();
